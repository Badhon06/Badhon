...
def update():
    ...
    try:
        ...
        toolVersion = "BadhonNoob"

    

    try:

        mainVersion = requests.get("https://raw.githubusercontent.com/Badhon-Noob/BadhonBomber/main/more/.version").text
    ...
    os.system("cd .. && rm -rf BadhonBomber && git clone https://github.com/Badhon-Noob/BadhonBomber > /dev/null 2>&1")
    ...
    os.system("cd .. && cd BadhonBomber && python Tbomb.py")
...
def logo():
    ...
    print("\033[94m│     \033[92m888888b.                 888 888                        

888  "88b                888 888                        

888  .88P                888 888 \033[94m   │".center(columns+15))

    print("\033[94m│     \033[92m 8888888K.   8888b.   .d88888 88888b.   .d88b.  88888b.  

888  "Y88b     "88b d88" 888 888 "88b d88""88b 888 "88b 

888    888 .d888888 888  888 888  888 888  888 888  888 ▖\033[94m   │".center(columns+15))

    print("\033[94m│     \033[92m 888   d88P 888  888 Y88b 888 888  888 Y88..88P 888  888   \033[94m   │".center(columns+15))

    print("\033[94m│     \033[92m 8888888P"  "Y888888  "Y88888 888  888  "Y88P"  888  888 \033[94m   │".center(columns+15))

    print("\033[94m│                              \033[94m          │".center(columns+9))

    print("\033[94m│ \033[95mAuthor : BadhonNoob                     \033[94m│".center(columns+15))

    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))

    print("│ \033[95mGitHub : https://github.com/Badhon-Noob \033[94m│".center(columns+9))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mBadhonBomber\n")
